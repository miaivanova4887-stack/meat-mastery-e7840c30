    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="sticky top-0 z-20 bg-background/80 backdrop-blur-lg border-b border-border/40">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <button
            onClick={() => {/* future: health sync settings */}}
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        <div className="bg-card rounded-xl p-4 border border-border flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] text-muted-foreground">Connect Apple Health or Google Health Connect to auto-sync your data.</p>
          </div>
          <Button size="sm" variant="outline" className="shrink-0 text-xs" onClick={() => navigate("/progress/sync")}>
            Setup
          </Button>
        </div>
      </div>
