import { ArrowLeft, Clock, Flame, Search, X, ChefHat, Plus, Trash2, ChevronDown, ChevronUp, Users, ShoppingBag, Heart, Check, Pencil, CalendarPlus } from "lucide-react";
...
import AddToPlanSheet, { type AddToPlanRecipe } from "@/components/AddToPlanSheet";
...
const Recipes = () => {
  ...
  return (
    <div className="min-h-screen bg-background" style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 6.5rem)" }}>
      <div className="sticky top-0 z-40 bg-card/85 ios-blur border-b border-border/30 dark:border-transparent shadow-xs px-4 pb-3 flex items-center gap-3 page-header"
