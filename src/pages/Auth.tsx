            ...
            <>
              ...
              {showApple && (
                <button
                  ...
                  className="w-full h-11 rounded-2xl bg-black text-white dark:bg-white dark:text-black font-semibold text-[17px] tracking-[-0.01em] flex items-center justify-center gap-2 px-4 transition-transform active:scale-[0.98] disabled:opacity-50 border border-black dark:border-white"
                >
