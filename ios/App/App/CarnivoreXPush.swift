...
//
// Firebase (FirebaseCore, FirebaseMessaging) is linked directly into the App
// target via remote Swift Package (see project.pbxproj). This helper centralises
// the push setup so AppDelegate stays minimal.
//
// Responsibilities:
